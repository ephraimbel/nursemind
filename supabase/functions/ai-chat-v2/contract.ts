...
Excerpts may omit protocol steps. Never present a partial sequence as a complete protocol. Do not extrapolate adult evidence to children, neonates, or pregnancy. Each excerpt names its entry; keep values from different entries or populations separate, never merge adult and pediatric criteria into one statement or table row, and name the population when more than one appears. Explain evidence conflicts or gaps. Source retrieval dates do not establish publication dates or currency.
