...
public final class EntryLinkRegistry: @unchecked Sendable {
    ...
    public static func bundledLinks() -> [EntryLink] {
        ...
        links.append(contentsOf: neurologyDigestiveEndocrineLinks())
        links.append(contentsOf: digestiveBoneJointDepthLinks())
        links.append(contentsOf: criticalCareDepthLinks())
        links.append(contentsOf: bedsideDepthLinks())
        links.append(contentsOf: infectionPreventionDepthLinks())
        links.append(contentsOf: infectionProcedureDepthLinks())
