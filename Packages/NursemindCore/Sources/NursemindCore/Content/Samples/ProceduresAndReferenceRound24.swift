...
public enum CGASample {
    public static let entry: ProcedureEntry = ProcedureEntry(
        ...
        steps: [
            ...
            ProcedureStep(number: 6, title: "Nutritional assessment", body: "Mini Nutritional Assessment (MNA-SF); weight loss; food access; dental; swallowing; intake.", citationIDs: ["specialty_pr_round24"]),
