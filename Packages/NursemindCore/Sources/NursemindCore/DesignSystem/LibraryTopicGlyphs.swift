...
extension LibraryTopic {
    var glyph: String {
        ...
        case "infection-prevention": "shield"
        case "skin-mobility-comfort", "musculoskeletal-skin": "figure.walk"
        case "nutrition-elimination", "gastrointestinal", "nlm-gastrointestinal": "fork.knife"
