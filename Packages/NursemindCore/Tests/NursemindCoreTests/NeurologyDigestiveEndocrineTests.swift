...
@Suite("Neurology, digestive and endocrine expansion")
struct NeurologyDigestiveEndocrineTests {
    static let entryIDs: [String] = [
        "reference:parkinson-daily-function-support",
        "reference:als-communication-daily-support",
        "reference:guillain-barre-recovery-support",
        "reference:peripheral-neuropathy-daily-support",
        "reference:cirrhosis-nutrition-daily-support",
        "reference:pancreatic-insufficiency-nutrition-support",
        "reference:adrenal-insufficiency-illness-preparation",
        "reference:hypothyroidism-treatment-follow-up"
    ]
