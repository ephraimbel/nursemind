...
@Suite("Infection, renal and cardiac reference depth")
struct InfectionProcedureDepthTests {
    static let entryIDs: [String] = [
        "reference:cre-bedside-transfer-precautions",
        "reference:hemodialysis-access-observation",
        "reference:peritoneal-dialysis-infection-recognition",
        "reference:kidney-biopsy-preparation-recovery",
        "reference:nephrotic-syndrome-follow-up",
        "reference:kidney-stone-recovery-prevention",
        "reference:cardiac-catheterization-preparation-recovery",
        "reference:planned-cardioversion-preparation-recovery",
        "reference:permanent-pacemaker-follow-up",
        "reference:icd-shock-follow-up",
        "reference:cardiac-surgery-recovery-support"
    ]
