...
Last updated: 2026-08-11 · v1.2.0 (20) SUBMITTED (Waiting for Review, 4:06 PM) after the second 1.4.2 rejection — fluid calculators cut, dosing copy scrubbed everywhere, AI hardened, ASC metadata fixed (live description had claimed Parkland + drip rate calculators), reply posted in the rejection thread
