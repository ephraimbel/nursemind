...
- Entries reachable through selected topic collections: **572**.
...
New registered entries: 20. This is the shared workspace total and can include concurrent work.
