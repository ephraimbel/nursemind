...
- Entries reachable through selected topic collections: **669**.
...
New registered entries: 10. This is the shared workspace total and can include concurrent work.

| Existing entry | Before words | After words |
|---|---:|---:|
| procedure:hand-hygiene | 298 | 303 |
| reference:contact-precautions | 207 | 199 |
