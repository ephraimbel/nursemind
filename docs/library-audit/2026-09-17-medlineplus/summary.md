...
- Entries reachable through selected topic collections: **552**.
...
New registered entries: 221. This is the shared workspace total and can include concurrent work.

| Existing entry | Before words | After words |
|---|---:|---:|
| diagnosis:atopic-dermatitis | 435 | 436 |
| diagnosis:eczema-atopic | 375 | 380 |
