...
- Entries reachable through selected topic collections: **659**.
...
New registered entries: 17. This is the shared workspace total and can include concurrent work.

| Existing entry | Before words | After words |
|---|---:|---:|
| procedure:hand-hygiene | 326 | 298 |
| reference:contact-precautions | 224 | 207 |
| reference:droplet-precautions | 139 | 110 |
| reference:hand-hygiene-reference | 270 | 196 |
| reference:isolation-hierarchy | 378 | 380 |
| reference:isolation-precautions | 296 | 288 |
