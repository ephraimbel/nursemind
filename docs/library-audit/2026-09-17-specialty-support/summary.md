...
- Entries reachable through selected topic collections: **329**.
...
New registered entries: 50. This is the shared workspace total and can include concurrent work.

| Existing entry | Before words | After words |
|---|---:|---:|
| reference:neutropenic-precautions | 371 | 418 |
